...
namespace KarveControls
{
    ...
    class HolidayCalendar : Control, INotifyPropertyChanged
    {
 ...
 typeof(HolidayCalendar), new FrameworkPropertyMetadata(new List<int>()));*/
        ...
        {
            {1, new MonthData(){ RowIdx=0, ColIdx = 0, MonthIndex = 1, YearMonth="2018.01", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnJanuaryChange) }},
           {2, new MonthData(){ ColIdx = 1, RowIdx = 0, MonthIndex = 2, YearMonth="2018.02", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnFebChange) }},
          {3, new MonthData(){ ColIdx = 2, RowIdx = 0, MonthIndex = 3, YearMonth="2018.03", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnMarChange) }},
             {4, new MonthData(){ ColIdx = 3, RowIdx = 0,MonthIndex = 4, YearMonth="2018.04", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnAprChange) }},
 {5, new MonthData(){ColIdx = 0, RowIdx = 1, MonthIndex = 5, YearMonth="2018.05", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnMayChange) }},
 {6, new MonthData(){ColIdx =1, RowIdx = 1, MonthIndex = 6, YearMonth="2018.06", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnJunChange) }},
 {7, new MonthData(){ColIdx = 2, RowIdx = 1, MonthIndex = 7, YearMonth="2018.07", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnJulyChange) }},
 {8, new MonthData(){ColIdx = 3, RowIdx = 1, MonthIndex = 8, YearMonth="2018.08", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnAugChange) }},
 {9, new MonthData(){ ColIdx = 0, RowIdx = 2, MonthIndex = 9, YearMonth="2018.09", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnSeptChange) }},
 {10, new MonthData(){ ColIdx = 1, RowIdx = 2, MonthIndex = 10, YearMonth="2018.10", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnOctChange) }},
 {11, new MonthData(){ ColIdx = 2, RowIdx = 2,MonthIndex =11, YearMonth="2018.11", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnNovChange) }},
 {12, new MonthData(){ ColIdx = 3, RowIdx = 2,MonthIndex = 12, YearMonth="2018.12", DaysOff=new List<int>(), SelectedDayCommand=new DelegateCommand(OnDicChange) }}
