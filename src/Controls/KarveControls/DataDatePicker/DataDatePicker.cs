...
namespace KarveControls
{
  ...
  public class DataDatePicker : DateTimePickerBase
  {
    ...
    private DataTable _itemSource;
      ...
      {
          DataDatePicker controlDataField = d as DataDatePicker;
    ...
    {
            //DateTimeUpDown.IsFormatStringValid( value );
        return true;
    }
    ...
    public static readonly DependencyProperty TimeWatermarkTemplateProperty = DependencyProperty.Register( "TimeWatermarkTemplate", typeof( DataTemplate ), typeof( DateTimePicker ), new UIPropertyMetadata( null ) );
        private bool _fireSelectionChangedEvent;
        ...
        public DataTemplate TimeWatermarkTemplate
    {
      ...
      set
      {
        ...
        public DateTime ContextNow { get; private set; }
 ...
 //       _calendar.DisplayDate = Value ?? this.ContextNow;
    ...
    private void TimePicker_ValueChanged( object sender, RoutedPropertyChangedEventArgs<object> e )
    {
      ...
      if( this.UpdateValueOnEnterKey )
      {
        ...
        private string GetFormatString(DateTimeFormat format)
        {
...
/*
        ...
        private object GetClippedMinMaxValue(DateTime? newDate)
        {
            throw new NotImplementedException();
        }
