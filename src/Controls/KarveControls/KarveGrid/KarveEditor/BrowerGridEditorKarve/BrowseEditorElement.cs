...
namespace KarveControls.KarveGrid.KarveEditor.BrowerGridEditorKarve
{
    public class BrowseEditorElement : LightVisualElement
    {
        ...
        protected override SizeF ArrangeOverride(SizeF finalSize)
        {
            ...
            RectangleF buttonRect = new RectangleF(clientRect.Right - button_Renamed.DesiredSize.Width, clientRect.Top, button_Renamed.DesiredSize.Width, clientRect.Height);
            RectangleF textRect = new RectangleF(clientRect.Left, clientRect.Top + (clientRect.Height - textBox_Renamed.DesiredSize.Height) / 2, buttonRect.Left - clientRect.Left - 2, textBox_Renamed.DesiredSize.Height);
