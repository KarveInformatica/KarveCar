...
{
    public class MotivoCambioVehiculo : GenericPropertyChanged, IDataGridRowChange
    {
        #region Constructores
        public MotivoCambioVehiculo() { this.ControlCambio = RecopilatorioEnumerations.EControlCambio.Null; }
        public MotivoCambioVehiculo(string codigo, string definicion, string ultimamodificacion, string usuario)
        {
            this.codigo = codigo;
