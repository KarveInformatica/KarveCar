...
{
    /// <summary>
    /// Represents a  Comission delega plain clr object.
    /// </summary>
    [Table("COMI_DELEGA")]
    public class ComiDelegaPoco
	{
	
	/// <summary>
    ///  Set or get the cldIdCOMI property.
    /// </summary>
    
		public string cldIdCOMI { get; set; }

        /// <summary>
        ///  Set or get the cldIdDelega property.
        /// </summary>
        [Key]
        public Int32 cldIdDelega { get; set; }
	...
	/// <summary>
    ///  Set or get the cldCONCE_PVTA property.
    /// </summary>
    
		public string cldCONCE_PVTA { get; set; }

        /// <summary>
        ///  Set or get the NOM_PROV property.
        /// </summary>
    ...
    /// </summary>
		...
		public Int32? cldDFSE { get; set; }
		
 
	/// <summary>
    ///  Set or get the NUM_RED_DELEGA property.
    /// </summary>
    
		public string NUM_RED_DELEGA { get; set; }
 
	/// <summary>
    ///  Set or get the BAJA_DELCOMI property.
    /// </summary>
    
		public DateTime? BAJA_DELCOMI { get; set; }
