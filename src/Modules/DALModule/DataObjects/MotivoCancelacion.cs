...
{
    public class MotivoCancelacion : GenericPropertyChanged, IDataGridRowChange
    {
        #region Constructores
        public MotivoCancelacion() { this.ControlCambio = RecopilatorioEnumerations.EControlCambio.Null; }
        public MotivoCancelacion(string codigo, string definicion, string ultimamodificacion, string usuario)
        {
            this.codigo = codigo;
