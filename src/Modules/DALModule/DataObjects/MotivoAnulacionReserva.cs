...
{
    public class MotivoAnulacionReserva : GenericPropertyChanged, IDataGridRowChange
    {
        #region Constructores
        public MotivoAnulacionReserva() { this.ControlCambio = RecopilatorioEnumerations.EControlCambio.Null; }
        public MotivoAnulacionReserva(string codigo, string definicion, string ultimamodificacion, string usuario)
        {
            this.codigo = codigo;
