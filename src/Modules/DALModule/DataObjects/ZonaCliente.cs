...
{
    public class ZonaCliente : GenericPropertyChanged, IDataGridRowChange
    {
        #region Constructores
        public ZonaCliente() { this.ControlCambio = RecopilatorioEnumerations.EControlCambio.Null; }
        public ZonaCliente(string codigo, string definicion, string ultimamodificacion, string usuario)
        {
            this.codigo = codigo;
