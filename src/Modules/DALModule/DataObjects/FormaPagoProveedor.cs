...
{
    public class FormaPagoProveedor : GenericPropertyChanged, IDataGridRowChange
    {
        #region Constructores
        public FormaPagoProveedor() { this.ControlCambio = RecopilatorioEnumerations.EControlCambio.Null; }
        public FormaPagoProveedor(byte codigo, string definicion, string ultimamodificacion, string usuario)
        {
            this.codigo = codigo;
