...
{
    public class TipoVehiculo : GenericPropertyChanged, IDataGridRowChange
    {
        #region Constructores
        public TipoVehiculo() { this.ControlCambio = RecopilatorioEnumerations.EControlCambio.Null; }
        public TipoVehiculo(string codigo, string definicion, string ultimamodificacion, string usuario)
        {
            this.codigo = codigo;
