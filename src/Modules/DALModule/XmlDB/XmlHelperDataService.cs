...
{
    internal class XmlHelperDataService : IHelperDataServices
    {
        ...
        public Task<IEnumerable<DtoTransfer>> GetMappedAllAsyncHelper<DtoTransfer, T>()
        ...
        public Task<DtoTransfer> GetSingleMappedAsyncHelper<DtoTransfer, T>(string code)
