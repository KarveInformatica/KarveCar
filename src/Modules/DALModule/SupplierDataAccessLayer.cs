...
namespace DataAccessLayer
{
    ...
    class SupplierDataAccessLayer : ISupplierDataServices
    {
        ...
        */
        ...
        public async Task<DataSet> GetAsyncSupplierContacts(string supplierCode)
        {
            DataSet set = new DataSet("SupplierContacts");

            /*if (string.IsNullOrEmpty(supplierCode))
            {
                string supplierCodeQuery = string.Format(GenericSql.ContactsQuery, "'" + supplierCode + "'");
                set = await _queryExecutor.AsyncDataSetLoad(supplierCodeQuery);
                set.DataSetName = "SupplierContacts";
            }*/
            return set;
        }
        ...
        /*
        public void DeleteSupplier(IDictionary<string, string> viewModelQueries, string primaryKey, DataSet currentDataSet)
        {
            throw new NotImplementedException();
        }*/
    }
