...
{
    /// <summary>
    ///  Booking viewObject is the booking data transfer object that convey the information outside the data layer.
    ...
    /// </summary>
    public class BookingViewObject : LineBaseViewObject<BookingItemsViewObject>
    {
        ...
        /// </summary>
        [StringLength(100, ErrorMessage = "Locator valor demasiado ancho")]
        ...
        [StringLength(2, ErrorMessage = "Codigo demasiado ancho")]
        ...
        /// </summary>
        [MaxLength(1000, ErrorMessage = "Lugar devolucion es demasiado grande")]
        public string LUDEVO_RES1 { get; set; }

        /// <summary>
        ///  Set or get the LUENTRE_RES1 property.
        /// </summary>
        [StringLength(1000, ErrorMessage = "Lugar entrega es demasiado grande")]
        ...
        /// </summary>
        [Required]
        [StringLength(7, ErrorMessage = "Codigo cliente no valido")]
        ...
        /// </summary>
        [Required]
        [StringLength(7, ErrorMessage = "Codigo conductor no valido")]
        ...
        /// </summary>
        [Required]
        [StringLength(4, ErrorMessage = "Codigo grupo no valido")]
        public string GRUPO_RES1 { get; set; }

        /// <summary>
        ///  Set or get the HORA_RES1 property.
        /// </summary>
        [Required(ErrorMessage ="Ora vacia")]
        ...
        [StringLength(30, ErrorMessage = "Nombre reservas demasiado ancho")]
        public string NOMBRE_RES1 { get; set; }

        /// <summary>
        ///  Set or get the NOMCLI_RES1 property.
        /// </summary>
        [StringLength(30, ErrorMessage = "Nombre cliente demasiado ancho")]
        ...
        /// </summary>
        [Required]
        [StringLength(10, ErrorMessage = "Codigo tarifa demasiado ancho")]
        ...
        /// </summary>
        [Required]
        [StringLength(10, ErrorMessage = "Codigo contrato demasiado ancho")]
        public string CONTRATO_RES1 { get; set; }

        /// <summary>
        ///  Set or get the MEDIO_RES1 property.
        /// </summary>
        [StringLength(4, ErrorMessage = "Codigo demasiado ancho")]
        ...
        /// </summary>
        [StringLength(50, ErrorMessage = "Codigo referencia demasiado ancho")]
        ...
        /// </summary>
        [StringLength(10, ErrorMessage = "Nombre documento demasiado ancho")]
