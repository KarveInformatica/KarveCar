...
namespace KarveDataServices.ViewObjects
{
    ...
    /// </summary>
    public class OfficeViewObject : BaseViewObject
    {
        private IEnumerable<CityViewObject> _cities;
        private IEnumerable<ProvinceViewObject> _province;

        public OfficeViewObject(): base()
        {
            HolidayDates = new List<HolidayViewObject>();
            TimeTable = new List<DailyTime>();
            Currencies = new List<CurrenciesViewObject>();
        ...
        /// </summary>
        public IEnumerable<HolidayViewObject> HolidayDates { set; get; }
        /// <summary>
        ...
        /// <summary>
        ///  Currencies viewObject.
        /// </summary>
        public IEnumerable<CurrenciesViewObject> Currencies { set; get; }
        ...
        public IEnumerable<CityViewObject> City
        {
            get
            {
                return _cities;
        ...
        public IEnumerable<ProvinceViewObject> 
        ...
        public IEnumerable<CountryViewObject> Country { get; set; }
        public IEnumerable<ClientSummaryExtended> ClientDto { get; set; }
        public IEnumerable<DelegaContableViewObject> DelegaContable { get; set; }
        public IEnumerable<ZonaOfiViewObject> OfficeZone { get; set; }
    }
}
