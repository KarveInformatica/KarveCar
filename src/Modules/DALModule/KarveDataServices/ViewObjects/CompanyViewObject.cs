...
namespace KarveDataServices.ViewObjects
{
    ...
    /// </summary>
    public class CompanyViewObject : BaseViewObject
    {
        private string _name;
        private string _commercialName;

        public CompanyViewObject() : base()
        {
            City = new CityViewObject();
            Province = new ProvinceViewObject();
            Country = new CountryViewObject();
            Offices = new List<OfficeViewObject>();
        }
        ...
        public CityViewObject City { get; set; }

        public ProvinceViewObject Province { get; set; }

        public CountryViewObject Country { get; set; }
        /// <summary>
        ///  Offices of the company.
        /// </summary>
        public IEnumerable<OfficeViewObject> Offices { get; set; }
