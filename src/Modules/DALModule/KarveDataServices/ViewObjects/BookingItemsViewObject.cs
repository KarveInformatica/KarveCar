...
namespace KarveDataServices.ViewObjects
{
    ...
    /// </summary>
    public class BookingItemsViewObject: BaseViewObject
    {
        /// <summary>
        /// Concept variable.
        /// </summary>
        ...
        /// </summary>
        [Required]
        [Range(0, Int32.MaxValue, ErrorMessage = "Cantidad debe ser un numero valido")]
        ...
        /// </summary>
        [Display(Name = "Extra")]
        [Range(0, Int16.MaxValue, ErrorMessage = "Extra no valido")]
        public Int16? Extra
        {
            get
            {
        ...
        [Display(Name="Minimo")]
        [Range(0, Int32.MaxValue, ErrorMessage = "Minimo no valido")]
        public Int32 Min
        {
            set
            {
        ...
        [Display(Name="Max")]
        [Range(0, Int32.MaxValue, ErrorMessage = "Maximo no valido")]
        public Int32 Max
        {
            set
            {
        ...
        /// </summary>
        [Display(Name = "Dias")]
        [RegularExpressionAttribute(@"^[0-9]{1,40}$", ErrorMessage = "Los dias deben ser exprimido en valor numerico")]
        public string Days {
            get
            {
                return _days;
