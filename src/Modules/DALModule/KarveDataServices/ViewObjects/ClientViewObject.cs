...
{
    [DataContract]
    public class ClientViewObject: BaseViewObject
    {
        private string _clientNumber;
       
        private string _clientName;

        public ClientViewObject()
        {
            VisitsDto = new ObservableCollection<VisitsViewObject>();
            ContactsDto = new ObservableCollection<ContactsViewObject>();
            BranchesDto = new ObservableCollection<BranchesViewObject>();
        }
        [DataMember]
