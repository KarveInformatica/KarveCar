...
namespace KarveDataServices.DataObjects
{
    ...
    /// </summary>
    public class InvoiceViewObject : BaseViewObject
    {
     
        public InvoiceViewObject()
        {
            InvoiceItems = new List<InvoiceSummaryViewObject>();
        ...
        public IEnumerable<InvoiceSummaryViewObject> InvoiceItems { set; get; }
    }
