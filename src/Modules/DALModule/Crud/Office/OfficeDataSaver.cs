...
{
    class OfficeHolidays : IEqualityComparer<FESTIVOS_OFICINA>
    {
    ...
    /// </summary>
    class OfficeDataSaver : IDataSaver<OfficeViewObject>
    {
        ...
        public async Task SaveHolidaysAsync(OfficeViewObject office, IEnumerable<HolidayViewObject> holidayDto)
        {
            var currentPoco = _mapper.Map<OfficeViewObject, OFICINAS>(office);
        ...
        private async Task<bool> SaveHolidayOfficeAsync(IDbConnection connection, OFICINAS currentOffice, IEnumerable<HolidayViewObject> holidayDto)
        {
            ...
            IEnumerable<FESTIVOS_OFICINA> holidayOffice = _mapper.Map<IEnumerable<HolidayViewObject>, IEnumerable<FESTIVOS_OFICINA>>(holidayDto);
            ...
            try
            {
                ...
                var officeHolidays = currentHolidays as FESTIVOS_OFICINA[] ?? currentHolidays.ToArray();
        ...
        public async Task<bool> SaveAsync(OfficeViewObject office)
        {
