...
namespace ProvidersModule.ViewModels
{
    class ProviderInfoViewModel : BindableBase, IEventObserver
    {
        ...
        private bool _isSearchTableReadOnly;
        ...
        public bool DelegationSearchTable
        {
            get { return _isSearchTableReadOnly; }
            set { _isSearchTableReadOnly = value; RaisePropertyChanged("DelegationSearchTable"); }
        }
