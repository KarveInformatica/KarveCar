...
namespace ProvidersModule.Common
{
    internal class ProviderConstants
    {
        ...
        {
            Resources.ProviderConstants_GestiónDeAlbaranes, "Es Intracomunitario", "Gestionar IVA Importación", "Margen No Automatico"
        };
        ...
        internal const string ImagePath = "/ProvidersModule;component/Images/search.png";
        internal const string EmailImagePath = "/ProvidersModule;component/Images/email.png";
