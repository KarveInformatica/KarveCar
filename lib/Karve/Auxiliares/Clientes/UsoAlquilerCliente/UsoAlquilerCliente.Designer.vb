...
Partial Class UsoAlquilerCliente
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "UsoAlquilerCliente"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "UsoAlquilerCliente"
