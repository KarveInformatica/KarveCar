...
Partial Class TarjetasCredito
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "TarjetasCredito"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "TarjetasCredito"
