...
Partial Class NegociosCliente
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "NegociosCliente"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "NegociosCliente"
