...
Partial Class CanalesCliente
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "CanalesCliente"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "CanalesCliente"
