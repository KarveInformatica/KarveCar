...
Partial Class MercadosCliente
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "MercadosCliente"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "MercadosCliente"
