...
namespace ExtendedGrid.Microsoft.Windows.Controls
{
    ...
    public class DataGrid : MultiSelector
    {
        ...
        protected virtual void OnExecutedCopy(ExecutedRoutedEventArgs args)
        {
            ...
            Collection<string> formats = new Collection<string>(new string[] { DataFormats.Html, DataFormats.Text, DataFormats.UnicodeText, DataFormats.CommaSeparatedValue, System.Globalization.CultureInfo.CurrentCulture.TextInfo.ListSeparator });
