...
namespace TestClient.UserControls
{
    ...
    /// </summary>
    public partial class MultiTrippleSortPlacerControl : INotifyPropertyChanged
    {
        public MultiTrippleSortPlacerControl()
        {
            ...
            row["Publisher"] = "Microsoft";
            row["Owner"] = "Steve";
            codeViewer.LoadData("MultiTrippleSortPlacerControl");
        }
