...
using Apache.Ibatis.DataMapper.Sysbase.Test.Domain;
    ...
    public class CodeConfigurationInterpreterTestFixture : BaseTest
    {
        ...
        public void CodeConfigurationMatchesSqlMapConfig()
        {
            ...
            */
            ...
            codeConfig.AddDatabase(new SysbaseDataProvider(), "");
            // codeConfig.AddDatabase(new SqliteDbProvider(), "Data Source=ibatisnet.sysbase;Version=3;");
