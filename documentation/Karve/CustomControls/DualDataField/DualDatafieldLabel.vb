...
Public Class DualDatafieldLabel
    Inherits DualDatafield

    'OJO EN EL DESIGNER NO SE VE BIEN, PERO EN LAS PANTALLAS SI
...
#Region "Propiedades"
    ...
    ReadOnly Property Text_Relacionado As String
        Get
            Return Me.dtfDesc.Text_Data
        End Get
    End Property
...
#Region "Eventos"
    ...
    '*-----------------------------------------------
    'Esto sobra lo levanta el control del que hereda
    '*-----------------------------------------------
