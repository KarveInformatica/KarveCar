...
Partial Class BloquesFacturacion
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "BloquesFacturacion"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "BloquesFacturacion"
