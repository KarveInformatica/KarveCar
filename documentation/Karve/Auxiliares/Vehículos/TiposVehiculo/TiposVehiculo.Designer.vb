...
Partial Class TiposVehiculo
    ...
    Private Sub InitializeComponent()
        ...
        Me.Name = "TiposVehiculo"
        '
        '
        '
        Me.RootElement.ApplyShapeToControl = True
        Me.Text = "TiposVehiculo"
